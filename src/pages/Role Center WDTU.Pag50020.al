        ...
        area(processing)
        {
            ...
            group(WDTUOperations)
            {
                ...
                action(RadioShows)
                {
                    ...
                    Caption = 'Radio Shows';
                    Image = AddToHome;
                    RunObject = Page "Radio Show List WDTU";
                    Tooltip = 'Run Radio Show List page';
                }
                action(Playlists)
                {
                    ApplicationArea = Basic, Suite;
                    ...
                    RunObject = Page "Playlist Document WDTU";
                    Tooltip = 'Run Playlist Document page';
                }
            }
        }
    }
